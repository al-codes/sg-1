...
#    greeting.
def write_letter(sender_name):
    return "Dear " + full_title("Alex", "computerer") + ", I think you are amazing!" + "Sincerely, " + sender_name
write_letter("Nick")
